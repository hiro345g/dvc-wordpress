...
| キーワード | 意味            | 特徴                                              |
| ---------- | --------------- | ------------------------------------------------- |
| 8.3.31     | PHPのバージョン | 特定のマイナー・パッチバージョン                  |
...
- `php:8.3.31-cli-trixie`（`php:8.3.31-trixie`）
- `php:8.3.31-cli`（`php:8.3.31`）
...
- とりあえず動かしたい: `php:8.3.31-apache`
- Web サーバーとは別に動かしたい: `php:8.3.31-fpm`
...
すでに挙げられた `php:8.3-apache` や `php:8.3-fpm` と比較すると、以下の点が「利用する価値」となります。
